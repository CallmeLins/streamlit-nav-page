...
user_name = 'User'
gpt_name = 'ChatGPT'
# avtar(svg) from https://www.dicebear.com/playground?style=identicon
user_svg = """
...
function checkElements() {
    const textinput = window.parent.document.querySelector("textarea[aria-label='**Input:**']");   //label need match
